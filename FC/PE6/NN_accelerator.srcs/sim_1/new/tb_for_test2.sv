`timescale 1ns / 1ps
module tb_for_test2#(parameter size = 10);
    ...
    initial $readmemh("C:/Users/zuohaonan/Desktop/PE6_new/PE4/NN_accelerator/source_CNN06.txt", ram);
    ...
    file_handle = $fopen("C:/Users/zuohaonan/Desktop/PE6_new/PE4/NN_accelerator/ofm_data06.txt", "r");
    i = 0;
   ...
   always@(posedge clk)
       begin
         if(!rst) begin
          ...
          if(((count >= 0)&&(count < 351))||(data_req && start && (raddr < 383)))
            begin
              v_from_router <= 1;
              raddr <= raddr + 1;
