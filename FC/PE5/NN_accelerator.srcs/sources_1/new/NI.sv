`timescale 1ns / 1ps
module NI #(parameter FLIT_WIDTH = 48, CREDIT_WIDTH = 6, ID_BITS = 6)(
    input clk, 
    input rst,
    ...
    output logic wen,
    (*keep="true"*)output logic [22:0] weight_info,
            ...
            begin
                ...
                begin
                    ...
                    case (from_router_flit[16+:7])
                        ...
                        7'd1:
                        begin
                            weight_info <= from_router_flit[0+:23] ;
                            v_bias <= 0;
                        end
                        7'd2:
                        begin
