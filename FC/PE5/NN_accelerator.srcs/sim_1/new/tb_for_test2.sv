`timescale 1ns / 1ps
module tb_for_test2#(parameter size = 32);
    ...
    initial $readmemh("C:/Users/zuohaonan/Desktop/PE5_new/PE4/NN_accelerator/source_CNN05.txt", ram);
    ...
    file_handle = $fopen("C:/Users/zuohaonan/Desktop/PE5_new/PE4/NN_accelerator/ofm_data05.txt", "r");
    i = 0;
   ...
   always@(posedge clk)
       begin
         if(!rst) begin
          ...
          if(((count >= 0)&&(count < 2145))||(data_req && start && (raddr < 2210)))
            begin
              v_from_router <= 1;
              raddr <= raddr + 1;
